<?php
	...
	include_once "comp/templates.php";
		...
		<div class="container" id="list_container">
			...
			<div class="form-control display-flex" id="sort_and_filter">
					<div class="flex-none filter-button">
						<button data-filter="category" data-value="ETH" type="button" class="form-button filter">ETH</button>
					</div>
					<div class="flex-none filter-button">
						<button data-filter="category" data-value="Rare" type="button" class="form-button filter">Rare</button>
					</div>
					<div class="flex-none filter-button">
