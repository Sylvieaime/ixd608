...
$empty_product = (object)[
	"name"=>"2D installation",
	"price"=>"9.99",
	"quantity"=>"25",
	"description"=>"Embark on an Impressionist journey with our latest NFT exhibition of one of the most extraordinary pastel collections. The first journey from 2D&3D art installation into the NFT space.  Almost sold out on NFT Marketplace.
Contract address 1EYE - 0x0B56079c7f2912Af1642800607889a295BCA861F
Welcome to join our community  and not affiliated with BAYC",
	"images"=>"NFTartwork.jpg",
	"category"=>"dessert"
];
...
function productListItem($r,$o) {
	...
	<div class="card soft">
		<div class="display-flex">
			<div class="flex-none"><img src="../images/$o->images" style="height:100px;width:100px;border-radius:5px;margin-right:10px"></div>
...
$images = array_reduce(explode(", ", $o->images),function($r,$o){
	...
	$display = <<<HTML
		<div>
			...
			<div class="form-control">
				<strong>Image</strong>
				<span><br><br><img src='../images/$o->images' id="thumbnail_admin"></span>
			</div>
		</div>
	HTML;
...
<!--     <base href="http://karenchangart.com/aau/ixd608/chang.karen/">
    ...
    <link rel="stylesheet" href="midterm/midtermstyleguide.css" /> -->
